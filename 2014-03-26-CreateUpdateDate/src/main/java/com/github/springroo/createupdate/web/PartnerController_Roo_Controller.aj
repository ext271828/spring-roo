...
import com.github.springroo.createupdate.web.PartnerController;
...
privileged aspect PartnerController_Roo_Controller {
    ...
    void PartnerController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("partner_createddate_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
        uiModel.addAttribute("partner_modifieddate_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
